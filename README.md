...
The project is currently implemented through Phase 14 as an MVP/foundation build. For architecture, implementation history, and future work, start with [menu.md](menu.md).
